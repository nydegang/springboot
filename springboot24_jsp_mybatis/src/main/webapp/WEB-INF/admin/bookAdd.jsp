		...
		<div class="row  card">
			<div class="col-md-12">
              <div class="card-header">
				...
				<form:form action="bookAdd" method="post" enctype="multipart/form-data" modelAttribute="book">
					<!--  name -->
					...
					<div class="form-group row">
						...
						<div class="col-sm-10">
							<div class="custom-file">
								<input type="file" name="photox" class="custom-file-input" /> <label class="custom-file-label" for="customFile"> 选择图片 </label>
							</div>
						</div>
					</div>
					<!-- pubdate -->
					...
					<div class="form-group row">
						<form:label path="vcode" cssClass="col-sm-2 col-form-label">验证码:</form:label>
							<div class="col-sm-6">
							    <form:input path="vcode"  cssClass="form-control"  maxlength="4"/>
